...
declare module "jsonwebtoken" {
     ...
     */
    export function sign(payload: Object | Buffer | String, secretOrPrivateKey:
                             Buffer
                             | String, options?: SignOptions, callback?: SignCallback): String | void;
     ...
     */
    export function verify(token: String, secretOrPublicKey:
                               Buffer
                               | String, options?: VerifyOptions, callback?: VerifyCallback):
        Object
        | Buffer
        | String
        | void;
